...
export default function Header() {
    ...
    return (
        <header className="w-full bg-[#034256] flex flex-col items-center justify-center ">
            ...
            <div className='block sm:hidden top-24 w-full h-full'>
                <Navbar isOpen={openMenu} />
            </div>
        </header >
    )
